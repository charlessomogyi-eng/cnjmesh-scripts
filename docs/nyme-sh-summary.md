...
- Server: `mqtt.nyme.sh`
- Username: `meshdev` / Password: `[REDACTED - broker password, scrubbed Aug 30 2026]` (Meshtastic default creds — same ones CNJ Mesh currently uses and is planning to rotate)
- Encryption: yes
