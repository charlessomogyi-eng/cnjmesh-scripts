...
DISCORD_WEBHOOK_URL = os.environ.get("CNJ_DISCORD_WEBHOOK", "https://discord.com/api/webhooks/[REDACTED - webhook ID, scrubbed Aug 30 2026]/pn4PUcrUNQ7CMMOkuE-BIWyT0l4NOE1TeA54pXsiaBcsC19JKaPLnWDdciZJdz6pry7x")
...
CROSS_POST_WEBHOOK = os.environ.get("CROSS_POST_WEBHOOK", "[REDACTED - webhook URL, scrubbed Aug 30 2026]")
